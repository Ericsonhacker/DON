...
#AUTHOR : CHIGOZIEWORLDWIDE (DON)
#OPEN SOURCE :)
#DON'T FORGET TO GIVE CREDIT TO DON
...
header = {"user-agent": '[Mozilla/5.0 (iPhone; CPU iPhone OS 15_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/15.2 Mobile/15E148 Safari/604.1;]',
